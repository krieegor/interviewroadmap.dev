...
export type BrokerClusterLabels = {
  broker1: string;
  broker2: string;
  broker3: string;
  leader: string;
...
export default function BrokerClusterScene({ labels }: { labels: BrokerClusterLabels }) {
  ...
  return (
    ...
    >
      ...
      <Node3D position={POSITIONS[0]!} label={labels.broker1} sublabel={labels.leader} colors={colors} variant="accent" />
