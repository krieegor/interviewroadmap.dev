...
const LABELS: ReplayLabels = {
  committedOffset: "offset commitado",
  newReadPosition: "novo ponto de leitura",
};

const STEP_LABELS = ["Antes do replay", "Depois de resetar o offset para 2"];
...
export function ReplayDiagramSvg() {
  return (
    <svg
      viewBox="0 0 640 260"
      role="img"
