export function CircuitBreakerDiagram() {
  return (
    <svg
      viewBox="0 0 640 220"
      role="img"
      aria-label="Circuit breaker fechado permite chamadas normalmente; apos muitas falhas, abre e passa a rejeitar chamadas imediatamente; apos um tempo, entra em half-open testando uma chamada; se suceder volta a fechado, se falhar volta a aberto."
