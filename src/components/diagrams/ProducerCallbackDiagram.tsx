export function ProducerCallbackDiagram() {
  return (
    <svg
      viewBox="0 0 620 200"
      role="img"
      aria-label="KafkaTemplate.send() envia ao broker de forma assincrona; o resultado retorna via callback, chamando onSuccess com o SendResult ou onFailure com a excecao."
